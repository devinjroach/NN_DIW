...
Y2 = model(X)[100].unsqueeze(dim=0).detach().numpy()
delta2 = Y2[0,0]
rvar1 = Y2[0,1]
rvar2 = Y2[0,2]
rvar3 = Y2[0,3]
...
change3 = 1.0
y_tmp[0,0] = delta2
y_tmp[0,1] = rvar1 + change1 #rvar1 #rv1
y_tmp[0,2] = rvar2 + change2 #rv2
y_tmp[0,3] = rvar3 + change3 #rv3
#print(y_tmp)
